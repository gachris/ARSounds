...
public class MessageBox : MonoBehaviour
{
    ...
    private delegate void DelegateMessageBoxButtonAction();
    private DelegateMessageBoxButtonAction m_DelegateMessageBoxAction;
    #endregion // PRIVATE_MEMBERS

    #region PUBLIC_METHODS

    public static void Show(string title, string body, bool dismissable, Action dismissAction)
    {
    ...
    public void MessageBoxButton()
    {
        ...
        m_DelegateMessageBoxAction?.Invoke();
    ...
    private void Setup(string title, string body, bool dismissable = true, Action closeButton = null)
    {
