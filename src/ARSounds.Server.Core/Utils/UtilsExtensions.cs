...
public static class UtilsExtensions
{
    ...
    public static byte[] Base64ImgToByteArray(this string img, ImageType imageType)
    {
    ...
    public static string GetImageAsBase64(this byte[] img, ImageType imageType, bool usePrefix)
    {
