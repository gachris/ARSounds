...
public abstract class ApiControllerBase : ControllerBase
{
    ...
    {
        return new ResponseMessage(Guid.NewGuid(), Responses.StatusCode.Success, []);
    }
    ...
    {
        return new ResponseMessage(Guid.NewGuid(), Responses.StatusCode.Success, [new(ResultCode.InternalServerError, message)]);
    }
    ...
    {
        return new ResponseMessage<TResult>(new ResponseDoc<TResult>(result), Guid.NewGuid(), Responses.StatusCode.Success, []);
    }
