...
public interface ITargetsService
{
    ...
    /// <summary>
    /// Activates a target by creating a new trackable image asset for it.
    /// </summary>
    /// <param name="id">The target identifier.</param>
    /// <param name="activateTargetDto">The data containing the activation details.</param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>The target with an activated trackable image asset.</returns>
    ...
    /// <param name="id">The target identifier.</param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>The target with the trackable image asset removed.</returns>
