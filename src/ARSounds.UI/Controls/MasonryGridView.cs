...
public class MasonryGridView : Layout<View>
{
    ...
    private readonly Dictionary<View, Rect> _arrangeInfo = new Dictionary<View, Rect>();
    ...
    private void OnOrientationChanged(BindableObject bindable, object oldValue, object newValue)
    {
    ...
    private void OnItemWidthOrHeightChanged(BindableObject bindable, object oldValue, object newValue)
    {
