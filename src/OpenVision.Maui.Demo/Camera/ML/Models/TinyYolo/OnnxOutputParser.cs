...
public class TinyYoloOutputParser
{
    ...
    public TinyYoloOutputParser(string[] classLabels, (float x, float y)[] boxAnchors)
    {
        _classLabels = classLabels;
        _boxAnchors = boxAnchors;
    }
    ...
    public List<TinyYoloPrediction> ParseOutputs(float[] modelOutput, float probabilityThreshold = 0.3f)
    {
        var boxes = new List<TinyYoloPrediction>();
    ...
    public List<TinyYoloPrediction> FilterBoundingBoxes(List<TinyYoloPrediction> boxes, int limit, float iouThreshold)
    {
        var results = new List<TinyYoloPrediction>();
