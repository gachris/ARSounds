...
public class UltrafaceVision : VisionSampleBase<UltrafaceImageProcessor>
{
    ...
    private List<UltrafacePrediction> GetPredictions(Tensor<float> input, int sourceImageWidth, int sourceImageHeight)
    {
