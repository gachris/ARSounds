...
namespace ARSounds.ApiClient.DataStore;

/// <summary>FileDataStore</summary>
public class FileDataStore : IDataStore
{
    private const string XdgDataHomeSubdirectory = "arsounds-filedatastore";
    ...
    {
        var environmentVariable = Environment.GetEnvironmentVariable("APPDATA");
