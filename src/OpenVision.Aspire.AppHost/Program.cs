    ...
    case DatabaseProviderType.MySql:
        {
            ...
            arsoundsResourceBuilder = resource.AddDatabase("ARSoundsDataDbConnection", "ARSounds");
            openVisionDataDbConnectionResourceBuilder = resource.AddDatabase("OpenVisionDataDbConnection", "OpenVision");
...
builder.AddProject<Projects.ARSounds_Server>("openvision-arsounds")
       .WithEnvironment("DatabaseConfiguration:ProviderType", databaseProviderTypeParameter)
       .WithEnvironment("DatabaseConfiguration:UsePooledDbContext", usePooledDbContextParameter)
