...
- Create Angular project with ng: `ng new arsounds.web.app.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`arsounds.web.app.client.esproj`).
