...
import { SignInOidcCallbackComponent } from './signin-callback-oidc/signin-callback-oidc.component';
...
const routes: Routes = [
  {
    path: '', component: PublicComponent, data: { title: 'Public Views' }, children: [
      ...
      { path: 'signin-callback-oidc', component: SignInOidcCallbackComponent },
      { path: 'signout-callback-oidc', component: SignOutCallbackOidcComponent },
      { path: 'silent-callback-oidc', component: SilentCallbackOidcComponent },
    ]
  }
];
